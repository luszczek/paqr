/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas/magmablas_zpaqr2_batched_fused_sm.cu, normal z -> d, Tue Apr 12 21:49:49 2022
*/

#include <cuda.h>    // for CUDA_VERSION
#include "magma_internal.h"
#include "magma_templates.h"
#include "magmablas_dpaqr2_batched_fused.cuh"
    ...
    magma_int_t batchCount)
{
    ...
    for(int j = 0; j < N; j++){
        ...
        // have the diagonal
        tmp = (tx == ir) ? MAGMA_D_MAKE(beta, MAGMA_D_ZERO) : sA(tx, j);
...
magma_dpaqr2_fused_sm_batched(
    magma_int_t m, magma_int_t n,
    double** dA_array, magma_int_t Ai, magma_int_t Aj, magma_int_t ldda,
    double **dtau_array, magma_int_t taui,
    magma_int_t** iflag_array, magma_int_t iflag_i,
    magma_int_t* info_array, magma_int_t nthreads, magma_int_t check_launch_only,
    double tol, magma_int_t batchCount, magma_queue_t queue )
{
