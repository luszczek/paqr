/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas/magmablas_zpaqr2_batched_fused_sm.cu, normal z -> s, Tue Apr 12 21:49:49 2022
*/

#include <cuda.h>    // for CUDA_VERSION
#include "magma_internal.h"
#include "magma_templates.h"
#include "magmablas_spaqr2_batched_fused.cuh"
    ...
    magma_int_t batchCount)
{
    ...
    for(int j = 0; j < N; j++){
        ...
        // have the diagonal
        tmp = (tx == ir) ? MAGMA_S_MAKE(beta, MAGMA_D_ZERO) : sA(tx, j);
